...
//               <div className="font-medium text-gray-900">{new Date(job.deadline).toLocaleDateString()}</div>
...
//                 <p className="text-green-700 mb-6">Your application has been successfully submitted. We'll review it and get back to you soon.</p>
//                 <Link
//                   to="/applicant"
...
//                     </div>
//                     <div>
//                       <div className="font-bold text-gray-900 text-lg">Welcome back, {user.name}!</div>
//                       <div className="text-gray-600">Ready to apply for this exciting opportunity?</div>
//                     </div>
//                   </div>
//                 </div>
...
//                     <p className="text-gray-600 mb-4">Please upload your resume in PDF format</p>
//                     <input
//                       type="file"
//                       accept=".pdf"
...
//                     >
//                       {resume ? `Selected: ${resume.name}` : 'Choose Resume File'}
//                     </label>
//                   </div>
//                 </div>
...
//               <p className="text-gray-700 mb-8 text-lg">You need to be logged in as an applicant to apply for this job.</p>
